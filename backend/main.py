...
def get_ngrok_url():
    try:
        ...
        pass  # Silently fail to avoid encoding issues
        return None
...
# Priority: Evolution API (free) -> Twilio (paid)
async def send_whatsapp_message(to_number: str, message: str):
    ...
    if evolution_service.enabled:
        ...
        if result:
            ...
            print(f"⚠️ Evolution API failed, trying fallback...")
    ...
    print("⚠️ No WhatsApp service available (Evolution API and Twilio both disabled)")
    return None
